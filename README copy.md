...
```env
BOT_EXECUTION_MODE=safe
BOT_TARGET_TIME_PER_CLINIC_SECONDS=180
BOT_DELAY_AFTER_BLOCK_CLICK_MS=2500
BOT_DELAY_AFTER_FIELD_CLICK_MS=2000
BOT_DELAY_AFTER_TYPING_MS=2500
BOT_DELAY_AFTER_SAVE_CHANGES_MS=3500
```

Esse modo adiciona esperas configuraveis depois de carregar o workflow, clicar em blocos, clicar em campos, digitar em autocompletes, selecionar opcoes e salvar alteracoes. O bot tambem mede o tempo por clinica e por etapa quando `BOT_MEASURE_TIMING=true`, gerando `logs/timing-report.json`.
